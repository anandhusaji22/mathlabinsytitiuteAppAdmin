...
MIDDLEWARE = [
    ...
    'user.middleware.RequestResponseTimeMiddleware',
]
...
DATABASES = {
    ...
    'default': {
         ...
         'HOST': '46.202.188.49', #IP of vps.can be changed to local host after django hosted on vps.
...
#test
# STATIC_URL = 'static/'
# STATIC_ROOT = '/usr/local/lsws/Edutech/env/Edutech/public/static'
# MEDIA_URL = 'media/'
# MEDIA_ROOT = '/usr/local/lsws/Edutech/env/Edutech/public/media'
